...
const Contact = () => {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", import.meta.env.VITE_CONTACT_FORM_KEY);
  ...
  if (sending === true) {
    Swal.fire({
      ...
      text: "We will contact you by mail",
      icon: "success",
  ...
  return (
    <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-28  pt-20 ">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 790 563"
        fill="none"
        className="md:h-[20rem] h-[16rem]"
      >
        <g id="Image">
          <g id="g14">
            <g id="g16">
      ...
      <form
        ...
        autoComplete="off"
      >
        <h1 className="title text-center mb-4 text-4xl font-semibold">
          Talk to Us
        </h1>

        {/* <!-- Name --> */}
        <div className="w-full">
          <label for="formName" className=""></label>
          <input
            type="text"
            id="formName"
            name="name"
            className="bg-gray-50 p-2 w-full rounded-lg"
            placeholder="Name"
			autoComplete="off"
            required
          />
        ...
        {/* <!-- E-mail --> */}
        <div className="w-full">
          <label for="formEmail" className=""></label>
          <input
            type="email"
            id="formEmail"
            className=" bg-gray-50 p-2 w-full rounded-lg"
